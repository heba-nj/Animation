    ...
    return (
        <div>
            <motion.div className="h-screen d-flex items-center font-jost"
                ...
                transition={{ delay: 3 }}>
                <h1 className="textt text-7xl mx-auto pt-[30vh] font-bold w-[700px]">Front-End React Developer</h1>
                ...
                >
                    <div className="code ">
                        <div className="text-[#666666]">&lt;!DOCTYPE &gt;<span className="text-[#33A9DC]">html&gt;</span><br /></div>
